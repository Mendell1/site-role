  ...
  Object.defineProperty(Element.prototype, 'innerHTML', {
    ...
    set(valor) {
      ...
      if (gerenciado) {
        ...
        // Os módulos observam o detalhe do evento. Reaplicar o mesmo HTML
        // gerava uma nova MutationObserver, que chamava o módulo outra vez.
        // Se o estado visual é idêntico, não há motivo para redesenhar.
